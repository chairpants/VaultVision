...
window.KIDS_SAFE_SHOWS = new Set([
  ...
  'BlueThunder', 'BuckRogers', 'CharmedtheSeries', 'Chase',
  'DoctorWho', 'DueSouth', 'Everwood', 'GeneRoddenberrysAndromeda',
  'HitchhikersGuidetotheGalaxy', 'KnightRider', 'LogansRun', 'LoneGunmen',
  'MaxHeadroom', 'Middleman', 'Persuaders', 'PowerRangers',
  'Space1999', 'StarTrekDS9', 'StarTrekTNG', 'StarTrekVoyager',
  'Tick', 'WonderYears', 'AreYouAfraidOfTheDark', 'EerieIndiana',
  'Spooksville', 'HeyVernIt', 'AdventuresinWonderland', 'AllegrasWindow',
  'BerenstainBears', 'BertandErniesGreatAdventures', 'BillNye', 'CliffordtheBigRedDogSeriesSeries',
  'CosmosaPersonalVoyage', 'Ghostwriter', 'GUTS', 'JimHensonHour',
  'LandOfTheLost1991', 'LittleBear', 'MartyStouffersWildAmerica', 'MouseFactory',
  'MrMen', 'NickArcade', 'PlanetEarth', 'RoundtheTwist',
  'SchoolhouseRock', 'Wishbone', 'WonderPetsEpisodeswithMissingEpisodes', 'Zoboomafoo',
  'Asteroid1997', 'Meteorites1998', 'Tornado1996', 'VolcanoFireOnTheMountain',
  'Y2KTheMovie', 'FoxKids', 'NickAtNite', 'SatMorning',
  'SNICK', 'TGIF',
]);
