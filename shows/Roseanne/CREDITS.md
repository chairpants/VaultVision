...
[a single archive.org item](https://archive.org/details/roseanne_202507)
that bundles the whole series, one folder per season. 221 entries across 9
seasons (ABC, 1988-97) — essentially the complete original run. Deep
gratitude to whoever assembled and uploaded the whole thing in one place.
Support the Archive: https://archive.org/donate

*Roseanne* is the property of its respective rights holders; this project
