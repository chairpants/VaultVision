...
This player streams
[a single archive.org item](https://archive.org/details/Animal_Farm_TNT_WOC_1999-10-03)
...
*Animal Farm* is the property of its respective rights holders; this project
streams a publicly hosted recording and hosts no video content itself.

## Poster art

`art/AnimalFarm.jpg` is the film's poster, via
[TMDB](https://www.themoviedb.org/movie/815). Already a 2:3 portrait,
