...
This player streams
[a single archive.org item](https://archive.org/details/A_Christmas_Story_TBS_WOC_1994-11-2x)
...
*A Christmas Story* is the property of its respective rights holders; this project
streams a publicly hosted recording and hosts no video content itself.

## Poster art

`art/AChristmasStory.jpg` is the film's poster, via
[TMDB](https://www.themoviedb.org/movie/850). Already a 2:3 portrait,
