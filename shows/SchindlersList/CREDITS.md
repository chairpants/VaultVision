...
This player streams
[a single archive.org item](https://archive.org/details/Schindlers_List_NBC_WOC_1997-02-23)
...
*Schindlers List* is the property of its respective rights holders; this project
streams a publicly hosted recording and hosts no video content itself.

## Poster art

`art/SchindlersList.jpg` is the film's poster, via
[TMDB](https://www.themoviedb.org/movie/424). Already a 2:3 portrait,
