...
This player streams
[a single archive.org item](https://archive.org/details/Armageddon_ABC_WOC_2001-04-30)
...
*Armageddon* is the property of its respective rights holders; this project
streams a publicly hosted recording and hosts no video content itself.

## Poster art

`art/Armageddon.jpg` is the film's poster, via
[TMDB](https://www.themoviedb.org/movie/95). Already a 2:3 portrait,
